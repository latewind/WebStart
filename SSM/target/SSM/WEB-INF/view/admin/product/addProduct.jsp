							...
							<div class="form-group">
								...
								<div class="input-group col-sm-2 col-sm-offset-7">
									<input type="text" id="num" class="form-control"
										placeholder="库存量" name="num" aria-describedby="basic-addon1">
