...
public class OrdersHome {
	...
	public Orders findById(java.lang.Integer id) {
		...
		try {
			Orders instance = (Orders) sessionFactory.getCurrentSession().get("com.latewind.test.Orders", id);
			if (instance == null) {
	...
	public List findByExample(Orders instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.latewind.test.Orders")
