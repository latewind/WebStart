...
/*
 * 验证码生成 CreateImage接受 ch nl n l 参数生成 一个包含 验证码和图片流的Vector
 */
public class IdentifyCode {
	...
	/**
	 * 创建验证码图片
	 * @param createTypeFlag ch-中文； nl-数字字母组合； n-数字；l-字母；
	 * @return vector 包含一个验证码String 和图片InputStream
	 */
	public Vector<Object> CreateImage(String createTypeFlag){
		 //1.在内存中创建一张图片
      ...
      //  setBorder(g);
       ...
       ByteArrayInputStream btInput= convertImageToStream(bi);
    ...
    private String createRandomChar(Graphics2D g,String baseChar) {//     * 创建随机字符
